...
## An Educational Approach to Generative Audio
...
### Getting Up to Speed
For students with different levels of experience in python and those coming from other languages, the beginning notebooks were all about getting an understanding of machine learning concepts while building the Python skills necessary. We started with covering the difference between ML and Deep Learning, moving from a conceptual understanding to implementation. The course follows a changing set of libraries, beginning with FastAi to reduce complexity, and maturing towards PyTorch, with sparse implementations of Lightning to introduce new sections. Moving from classic Machine Learning technieuqes to 
...
academy of finland? didnt know they had those